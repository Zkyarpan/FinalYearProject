...
const BlogEditPage = async ({ params }: BlogEditPageProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formDataToSend.append('fields', JSON.stringify(blogData));
  ...
  // Rest of the component JSX remains the same as BlogCreatePage,
  // just update the title and button text to reflect editing
  return (
