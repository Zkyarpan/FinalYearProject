...
const StoryEditPage = ({ params }: { params: { slug: string } }) => {
  ...
  useEffect(() => {
    const fetchStory = async () => {
      try {
        ...
        const story: Story = data.Result.story;

        if (!story.isOwner) {
          toast.error('You do not have permission to edit this story');
          router.push(`/stories/${params.slug}`);
          return;
        }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/stories/${formData.storyId}`, {
        method: 'PATCH',
        body: formDataToSend,
      });
      ...
      router.push(`/stories/${formData.storyId}`);
    } catch (error) {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              We couldn't load the story for editing.
            </p>
    ...
    <div className="min-h-screen bg-background py-8 relative">
      <div className="max-w-[1000px] mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl font-bold">Edit Your Story</h1>
            <p className="text-muted-foreground mt-1">
              Update your story and share your journey
            </p>
          </div>
      ...
      <AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => router.push(`/stories/${formData.storyId}`)}
