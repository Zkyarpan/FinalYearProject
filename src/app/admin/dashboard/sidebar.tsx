        ...
        >
          ...
          <AccordionItem value="item-5" className="p-0 shadow-none">
            ...
            <AccordionContent>
              <ul className="submenu space-y-2 pl-12 pr-5">
                <li>
                  <NavLink href="/checkbox" isAccordion={true}>
                    Check Box & Radio
                  </NavLink>
                </li>
                <li>
          ...
          <AccordionItem value="item-6" className="p-0 shadow-none">
            ...
            <AccordionContent>
              <ul className="submenu space-y-2 pl-12 pr-5">
                <li>
                  <NavLink href="/login" target="_blank" isAccordion={true}>
                    Login
                  </NavLink>
                </li>
                <li>
                  <NavLink href="/register" target="_blank" isAccordion={true}>
                    Register
                  </NavLink>
                </li>
                <li>
                  <NavLink href="/forgot" target="_blank" isAccordion={true}>
                    Forgot
                  </NavLink>
                </li>
                <li>
                  <NavLink href="/password" target="_blank" isAccordion={true}>
                    Password
                  </NavLink>
                </li>
              </ul>
