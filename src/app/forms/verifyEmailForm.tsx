...
//     // Add this inside your handleVerify function before making the fetch request
//     console.log(
//       'Verification Token:',
...
//       // Option 1: Clone the response before reading it for logging
//       const responseToLog = response.clone();
//       console.log('Response:', await responseToLog.text());
...
//       // Add approval status to user data
//       setUser({
...
//         approvalStatus: data.Result.user.approvalStatus || 'pending', // Add this
//       });
