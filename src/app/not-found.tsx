...
export default function NotFoundPage() {
  return (
    <div className="container flex flex-col items-center justify-center min-h-screen bg-white text-black dark:bg-[--background] dark:text-white mb-5">
      ...
      <Link
        href="/"
        className="mt-6 inline-flex items-center justify-center px-4 py-2 text-sm font-medium shadow-sm text-white bg-[hsl(210,96.1%,40%)] hover:bg-[hsl(210,96.1%,50%)] rounded-xl border border-[hsl(var(--border))] hover:shadow-md dark:bg-[#404040] dark:border-[#525252] hover:dark:bg-[#505050]"
      >
        <svg
