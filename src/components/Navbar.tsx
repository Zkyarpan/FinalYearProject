  ...
  return (
    <div className="w-full mx-auto flex flex-col relative">
      <div className="fixed top-0 left-0 w-full z-10">
        <nav className="flex justify-center mx-auto px-4 sm:px-6 lg:px-8 h-14">
          <div className="flex items-center justify-center w-full max-w-screen-xl backdrop-blur-md text-[hsl(var(--foreground))] px-4 py-2 rounded-lg">
