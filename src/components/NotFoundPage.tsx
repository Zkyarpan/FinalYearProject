  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-black dark:bg-[hsl(210,10%,10%)] dark:text-white">
      ...
      <Link href="/scroll" passHref>
        <a className="mt-6 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[hsl(210,96.1%,40%)] hover:bg-[hsl(210,96.1%,50%)] dark:bg-[hsl(210,10%,20%)] dark:hover:bg-[hsl(210,10%,25%)] transition duration-300 ease-in-out">
          <svg
