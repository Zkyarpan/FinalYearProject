...
const BlogSection = () => {
  const posts = [
    ...
    },
    {
      ...
      href: "#",
      description: "Optio sit exercitation et ex ullamco aliquid explicabo. Dolore do ut officia anim non ad eu.",
      date: "Mar 10, 2020",
      category: "Sales",
      author: {
        name: "Lindsay Walton",
      ...
      imageUrl: "https://images.unsplash.com/photo-1547586696-ea22b4d4235d?ixlib=rb-4.0.3&auto=format&fit=crop&w=3270&q=80"
    },
    {
      id: 3,
      title: "Improve your customer experience",
      href: "#",
      description: "Dolore commodo in nulla do nulla esse consectetur. Adipisicing voluptate velit sint adipisicing ex duis elit deserunt sint ipsum.",
      date: "Feb 12, 2020",
      category: "Business",
      author: {
        name: "Tom Cook",
      ...
      imageUrl: "https://images.unsplash.com/photo-1492724441997-5dc865305da7?ixlib=rb-4.0.3&auto=format&fit=crop&w=3270&q=80"
    }
  ];
    ...
    <div className="bg-[hsl(var(--background))] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-[hsl(var(--foreground))] sm:text-4xl">From the blog</h2>
            ...
            <article key={post.id} className="flex flex-col items-start">
              ...
              <div className="max-w-xl">
                ...
                <div className="group relative">
                  ...
                  <p className="mt-5 line-clamp-3 text-sm leading-6 text-[hsl(var(--muted-foreground))]">{post.description}</p>
                </div>
                <div className="relative mt-8 flex items-center gap-x-4">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-[hsl(var(--muted-foreground))]">{post.author.role}</p>
                  </div>
                </div>
              </div>
            </article>
