        ...
        <div className="flex items-center gap-x-3">
          ...
          <div className="flex items-center gap-3 px-1">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-52 bg-background border border-border dark:border-[#333333] rounded-xl shadow-lg z-50">
                  <div className="p-4 border-b border-border dark:border-[#333333] flex flex-col gap-1">
                  ...
                  <div className="p-2 flex flex-col gap-1">
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-sm rounded-lg group transition-colors flex items-center gap-2"
                    >
                      <User />
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-sm rounded-lg group transition-colors text-red-500 flex items-center gap-2"
                    >
                      {isLoading ? (
