      ...
      <div className="flex items-center justify-end w-full">
        <div className="flex items-center bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-20">
          <div className="flex items-center mr-3">
            <div className="relative flex w-full items-center rounded-xl border dark:bg-input bg-white px-4 py-1 transition-all duration-200 gap-x-2">
              <Search />
              <input
                type="text"
                placeholder="Search Mentality"
                className="w-full text-lg bg-transparent border-none outline-none focus:ring-0 transition-colors duration-200"
              />
            </div>
          </div>
